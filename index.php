      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the ideal car for you on Caar Seva.</h1>
    ...
    <div class="row"> 
      ...
      <!--<div id="testimonial-slider">-->
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">All Cars</a></li>
        </ul>
      </div>
...
<span class="price">₹<?php echo htmlentities($result->PricePerDay);?> /On Road Price</span> 
</div>
...
<!-- WhatsApp pop-up code -->
<script>
  window.onload = function() {
    var whatsappPopup = document.createElement('div');
    whatsappPopup.innerHTML = '<a href="https://wa.me/918151985566" target="_blank"><img src="assets/images/whatsapp.png" alt="WhatsApp" style="width: 50px; height: 50px; transition: transform 0.3s;"></a>';
    whatsappPopup.style.position = 'fixed';
    whatsappPopup.style.bottom = '10px';
    whatsappPopup.style.left = '10px';
    whatsappPopup.style.transform = 'scale(0.8)';
    whatsappPopup.style.zIndex = '9999';
    whatsappPopup.onmouseover = function() {
      this.style.transform = 'scale(1)';
    };
    whatsappPopup.onmouseout = function() {
    ...
    popup.innerHTML = `
      <h3>Planning to sell your car? </h3>
      <form id="detailsForm" action="send_email.php" method="post">
      ...
      <a href="https://www.instagram.com/caarseva/?hl=en"><i class="fa fa-instagram" aria-hidden="true" style="font-size: 24px; color: red; margin-right: 40px;"></i></a>
      <a href="https://wa.me/918151985566"><i class="fa fa-whatsapp" aria-hidden="true" style="font-size: 24px; color: green;"></i></a>
    `;
...
<style>
  ...
  .popup {
    ...
    animation-timing-function: cubic-bezier(0.68, -0.55, 0.27, 1.55); /* Easing function for smoother bounce */
  }
